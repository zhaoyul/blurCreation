#import "GPUImageGaussianSelectiveBlurFilterWithBrightnewss.h"
#import "GPUImageGaussianBlurFilter.h"
#import "GPUImageTwoInputFilter.h"

#if TARGET_IPHONE_SIMULATOR || TARGET_OS_IPHONE
NSString *const kGPUImageGaussianSelectiveBlurBrightnessFragmentShaderString = SHADER_STRING
( 
...
@implementation GPUImageGaussianSelectiveBlurFilterWithBrightnewss
...
- (id)init;
{
    ...
    selectiveFocusFilter = [[GPUImageTwoInputFilter alloc] initWithFragmentShaderFromString:kGPUImageGaussianSelectiveBlurBrightnessFragmentShaderString];
